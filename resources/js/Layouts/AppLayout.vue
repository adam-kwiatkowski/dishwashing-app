            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :active="route().current('utensils.index')"
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :active="route().current('events.index')"
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <jet-responsive-nav-link :active="route().current('utensils.index')"
                                                 :href="route('utensils.index')">
                            Utensils
                        </jet-responsive-nav-link>

                        <jet-responsive-nav-link :active="route().current('dishwashing.index')"
                                                 :href="route('events.index')">
                            Dishwashing
                        </jet-responsive-nav-link>
                    </div>
